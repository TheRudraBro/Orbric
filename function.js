...
const jerseys = [
  ...
  {id:5, club:'Manchester United', title:'Manchester United Home Jersey 25/26', edition:'Player', league:'Premier League', retro:false, colors:['#da291c','#ffe500'], price:1150},
  {id:6, club:'Manchester United', title:'Manchester United Away Jersey 25/26', edition:'Fan', league:'Premier League', retro:false, colors:['#1c1c1c','#da291c'], price:850},
  {id:7, club:'Manchester City', title:'Manchester City Home Jersey 25/26', edition:'Player', league:'Premier League', retro:false, colors:['#6cabdd','#1c2c5b'], price:1150},
  {id:8, club:'Arsenal', title:'Arsenal Home Jersey 25/26', edition:'Fan', league:'Premier League', retro:false, colors:['#ef0107','#ffffff'], price:850},
  {id:9, club:'Liverpool', title:'Liverpool Home Jersey 25/26', edition:'Player', league:'Premier League', retro:false, colors:['#c8102e','#00b2a9'], price:1150},
  {id:10, club:'Chelsea', title:'Chelsea Home Jersey 25/26', edition:'Fan', league:'Premier League', retro:false, colors:['#034694','#dba111'], price:850},
  {id:11, club:'Bayern Munich', title:'Bayern Munich Home Jersey 25/26', edition:'Player', league:'Bundesliga', retro:false, colors:['#dc052d','#ffffff'], price:1150},
  {id:12, club:'Bayern Munich', title:'Bayern Munich Third Kit 25/26', edition:'Fan', league:'Bundesliga', retro:false, colors:['#1a1a2e','#dc052d'], price:850},
  {id:13, club:'Borussia Dortmund', title:'Borussia Dortmund Home Jersey 25/26', edition:'Player', league:'Bundesliga', retro:false, colors:['#fde100','#000000'], price:1150},
  {id:14, club:'Inter Milan', title:'Inter Milan Home Jersey 25/26', edition:'Player', league:'Serie A', retro:false, colors:['#010e80','#000000'], price:1150},
  {id:15, club:'AC Milan', title:'AC Milan Home Jersey 25/26', edition:'Fan', league:'Serie A', retro:false, colors:['#fb090b','#000000'], price:850},
  {id:16, club:'Juventus', title:'Juventus Home Jersey 25/26', edition:'Player', league:'Serie A', retro:false, colors:['#000000','#ffffff'], price:1150},
  {id:17, club:'PSG', title:'Paris Saint-Germain Home Jersey 25/26', edition:'Player', league:'Ligue 1', retro:false, colors:['#004170','#da291c'], price:1150},
...
const leagueClubs = {
  'La Liga': ['FC Barcelona','Real Madrid','Atletico Madrid','Real Betis','Sevilla','Valencia'],
